...
**Version:** 0.7 &nbsp;|&nbsp; **Date:** 2026-07-14 &nbsp;|&nbsp; **Stage:** Building — Phase 0 foundations + Phase 1 engine (records, workflow, changesets) built; **casper-sales P1a** (product config) built; **casper-web** first engine wiring (Pipeline board + deal detail + list views on the real engine, D-018)
